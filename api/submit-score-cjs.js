...
module.exports = async function handler(req, res) {
  ...
  try {
    console.log('🎯 API /submit-score-cjs called with method:', req.method);
...
async function simulateTransaction(playerAddress, scoreAmount, transactionAmount, privateKey) {
