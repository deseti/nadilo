...
export class Enemy {
  ...
  private createHealthBar() {
    // Disable health bar creation to prevent lag
    this.healthBar = this.scene.add.graphics();
  }

  private updateHealthBar() {
    // Disable health bar updates to prevent lag
    // Health bar rendering every frame causes performance issues
    return;
  }
  ...
  update(target: Player) {
    ...
    // Health bar update disabled for performance
  ...
  takeDamage(damage: number): boolean {
    ...
    // Minimal visual feedback to prevent lag
    ...
    // Remove damage text to prevent lag
    // Damage numbers cause performance issues
  ...
  destroy() {
    ...
    // Remove all visual effects to prevent lag
    // Explosion and score popup effects cause performance issues
